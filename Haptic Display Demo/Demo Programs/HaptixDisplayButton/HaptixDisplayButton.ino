/*
Uses the force plate with the pin display demo to create buttons that
can be pushed. Force plate output should be attached to A1.
*/
  /////////////////////////
  //Frank New Change here.
  #define FP_THRESHOLD 180
  /////////////////////////
...
// 2-dimensional array of row pin numbers for LED screen:
const int row[8] = {
...
//  char key = keyboard.read();
      ...
      int force = analogRead(A1); //TODO:Change the pin to the correct one.
      Serial.println(force);
      if(force > FP_THRESHOLD){
            // turn button on
            letter(27,0,0);         
            letter(27,5,0);      
            letter(27,0,4);
