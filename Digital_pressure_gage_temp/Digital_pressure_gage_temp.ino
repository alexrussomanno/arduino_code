...
float slope3; float int3;
float v1_0;  float v2_0; float v3_0;
float v1_10; float v2_10; float v3_10;
...
void pressure_calibration(){
  ...
  Serial.print(v2_0,DEC); Serial.print(" ");
  ...
  Serial.print(v1_10,DEC); Serial.print(" "); 
  Serial.print(v2_10,DEC); Serial.print(" ");
  ...
  Serial.print(slope1,DEC); Serial.print(" "); 
  Serial.print(slope2,DEC); Serial.print(" ");
  ...
  Serial.print(int2,DEC); Serial.print(" ");
